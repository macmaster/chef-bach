...
if node[:bcpc][:hadoop][:kerberos][:enable] == true then
  ...
  generated_values['hbase.coprocessor.master.classes'] << 'org.apache.hadoop.hbase.security.access.AccessController'
  generated_values['hbase.coprocessor.regionserver.classes'] << 'org.apache.hadoop.hbase.security.access.AccessController'
  generated_values['hbase.coprocessor.region.classes'] << 'org.apache.hadoop.hbase.security.access.AccessController'
  generated_values['hbase.coprocessor.region.classes'] << 'org.apache.hadoop.hbase.security.access.SecureBulkLoadEndpoint'
  generated_values['hbase.coprocessor.region.classes'] << 'org.apache.hadoop.hbase.security.token.TokenProvider'
